 ...
 * @author vinic
 */
public class CadastroPetiscos extends javax.swing.JFrame {

    /**
     * Creates new form CadastroPetiscos
     */
    BeansPetiscos pet = new BeansPetiscos();
    DAOPetiscos control = new DAOPetiscos();
    ConexaoBD conex = new ConexaoBD();
    int flag = 0;
    public CadastroPetiscos() {
         try {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Pesquisar Petiscos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(Pesquisar, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1.setBounds(0, 0, 447, 250);

        jPanel2.setBackground(new java.awt.Color(0, 0, 0));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastrar Petiscos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N
        jPanel2.setForeground(new java.awt.Color(255, 255, 255));
        jPanel2.setLayout(null);
        jPanel2.add(nome);
        nome.setBounds(160, 70, 161, 20);
        jPanel2.add(descricao);
        descricao.setBounds(160, 100, 217, 20);

        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Nome:");
        jPanel2.add(jLabel2);
        jLabel2.setBounds(110, 70, 50, 14);
        ...
        jPanel2.add(jLabel4);
        jLabel4.setBounds(90, 130, 70, 14);
        ...
        jPanel2.add(Excluir);
        Excluir.setBounds(180, 230, 90, 23);
        ...
        Cancelar.setBounds(280, 190, 90, 23);
        ...
        jPanel2.add(Editar);
        Editar.setBounds(180, 190, 90, 23);
        ...
        jPanel2.add(Novo);
        Novo.setBounds(80, 190, 90, 23);

        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Id:");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(130, 40, 30, 14);
        jPanel2.add(id);
        id.setBounds(160, 40, 35, 20);
        jPanel2.add(valor);
        valor.setBounds(160, 130, 93, 20);

        getContentPane().add(jPanel2);
        jPanel2.setBounds(0, 250, 447, 270);

        setSize(new java.awt.Dimension(463, 561));
    ...
    private void SalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SalvarActionPerformed
        ...
        try {
            ...
            pet.setDescricao(descricao.getText());
            pet.setValor(Float.parseFloat(valor.getText()));
            limpaCampos();
            desabilitaCampos();
            Salvar.setEnabled(false);
            Cancelar.setEnabled(false);
    ...
    private void listaContatos() throws SQLException {
        ...
        petiscos = c.getLista("%" + Pesquisar.getText() + "%"); 
    ...
    private void alteraRegistro() throws SQLException {
        if (jTablePesquisa.getSelectedRow() != -1) {
            ...
            // Se a confirmação for SIM
            if (resp == JOptionPane.YES_NO_OPTION) {                
                DAOPetiscos controle = new DAOPetiscos(); 
                BeansPetiscos petiscos = new BeansPetiscos();
                
                petiscos.setId(Integer.parseInt(id.getText()));
                petiscos.setNome(nome.getText());
                petiscos.setValor(Float.parseFloat(valor.getText()));
                petiscos.setDescricao(descricao.getText());
                
                controle.altera(petiscos);
    ...
    private boolean verificaDados() {
        if ((!nome.getText().equals(""))&&(!descricao.getText().equals(""))&&(!valor.getText().equals(""))){            
            return true;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroPetiscos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroPetiscos().setVisible(true);
            }
        });
    }
